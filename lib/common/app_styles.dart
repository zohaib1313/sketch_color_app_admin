...
class AppColor {
  static const primaryBlueColor = Colors.blue;
  static const primaryBlueDarkColor = Color(0xff134395);
...
class AppTextStyles {
  ...
  static TextStyle textStyleNormalBodyBold = _fontBold.copyWith(fontSize: 15);
}
